...
[![Stars](https://img.shields.io/github/stars/KRNL-Execute-Update-v2.8?style=flat-square)](https://github.com)
...
git clone https://github.com/KRNL-Execute-Update-v2.8.git
cd KRNL-Execute-Update-v2.8
